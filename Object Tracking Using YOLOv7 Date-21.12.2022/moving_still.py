...
def classify_objects(frames_folder):
    ...
    with open(r'output_status_all_objects.csv', 'w', newline='') as csvfile:
...
if __name__ == '__main__':
    ...
    str = input("Enter the pasth where coordinates are saved - ")
    frames_folder = str

    # Classify objects and save results to CSV
    classify_objects(frames_folder)

    print("Results saved to output_status_all_objects.csv")
